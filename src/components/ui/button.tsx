...
const buttonVariants = cva(
    [
        ...
        "-translate-y-0.5 -translate-x-0.5 shadow-[2px_2px_0_0_theme(colors.border)]",
        "md:translate-x-0 md:translate-y-0 md:shadow-none",
        "md:hover:-translate-y-1 md:hover:translate-x-1 md:hover:shadow-[-4px_4px_0_0_theme(colors.border)]",
